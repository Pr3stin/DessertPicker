...
class ViewController: UIViewController {
    ...
    @objc func buttonTapped(_ sender: UIButton) {
        let selectedValue = dessertApi[sender.tag]
        print("Button tapped with value: \(selectedValue)")
